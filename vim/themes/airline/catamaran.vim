...
let s:N4 = [ '#ffffff', '#f47067', 255, 203 ] " Section A (Modified)
...
let s:I4 = [ '#ffffff', '#6BAD3F', 255, 53 ] " Section A (Modified)
...
let s:R4 = [ '#ffffff', '#008492', 255, 53  ] " Section A (Modified)
...
let s:V4 = [ '#ffffff', '#FF003F', 255, 53  ] " Section A (Modified)
...
let s:IA4 = [ '#ffffff', '#8C7B69', 239, 236 ] " Section A (Modified)
let g:airline#themes#catamaran#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA2)
let g:airline#themes#catamaran#palette.inactive_modified = { 'airline_a': s:IA4 }

" ┌─┐┌─┐┌┬┐┌┬┐┌─┐┌┐┌┌┬┐  ┬  ┬┌┐┌┌─┐
" │  │ │││││││├─┤│││ ││  │  ││││├┤
" └─┘└─┘┴ ┴┴ ┴┴ ┴┘└┘─┴┘  ┴─┘┴┘└┘└─┘

let g:airline#themes#catamaran#palette.commandline = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA2)
...
let s:ER = [ '#1f242a', '#ff4b82', 234, 204 ] " Error

...
export FZF_DEFAULT_OPTS="
  --style=minimal
  --color=fg:$PALETTE_FG1
  --color=bg:$PALETTE_BG2
  --color=hl:$PALETTE_UI_ACCENT
  --color=fg+:$PALETTE_FG0
  --color=bg+:$PALETTE_BG3
  --color=hl+:$PALETTE_UI_FOCUS
  --color=info:$PALETTE_UI_INFO
  --color=prompt:$PALETTE_UI_ACCENT_ALT
  --color=pointer:$PALETTE_UI_ACCENT
  --color=marker:$PALETTE_UI_SUCCESS
  --color=spinner:$PALETTE_UI_WARNING
  --color=header:$PALETTE_UI_FOCUS

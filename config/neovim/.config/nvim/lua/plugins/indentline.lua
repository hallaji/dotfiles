...
return {
  ...
  config = function()
    ...
    vim.g.indentLine_fileTypeExclude = { "text", "startify", "noice", "mason", "snacks_terminal", "snacks_dashboard" } -- Disable indentLine for text and startify buffers
    vim.g.indentLine_bufTypeExclude = { "help", "terminal", "nofile", "nowrite", "prompt", "quickfix" } -- Disable indentLine for help and terminal buffers

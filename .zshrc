...
alias trackdotfiles="dotfile config --local status.showUntrackedFiles normal"
alias untrackdotfiles="dotfile config --local status.showUntrackedFiles no"
...
export KEYID="0xF000CC43069F1A75DC5AEF0761CF4B720B545C3F"
